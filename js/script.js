...
// slick slider
    ...
    const $slickElement = $('.page .products-slider__items');
    ...
    let catalogRows = 2;
    const selectOptions = $('.show-catalog__select option');
    console.log(selectOptions);
    selectOptions.each(function(){
        $( this ).on('click',function(){
            catalogRows =   $( this ).attr('data-row');
            console.log(catalogRows)
            return catalogRows;
        });
    });
    console.log(catalogRows)
    // let selectOptions = document.querySelectorAll('.show-catalog__select option');
    // let catalogRows = 2;
    // selectOptions.forEach(function(selectOneOption){
    //     selectOneOption.addEventListener("click", function(){
    //         catalogRows = selectOneOption.dataset.row;
    //         console.log(catalogRows)
    //         return catalogRows;
    //     })
    ...
    $('.catalog-page .products-slider__items').slick({
        dots: true,
        infinite: false,
        rows: catalogRows,
        slidesPerRow:3,
      ...
      $('.galary-product__mainslider').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        arrows: false,
        fade: true,
        asNavFor: '.galary-product__subslider'
    });
    $('.galary-product__subslider').slick({
        slidesToShow: 4,
        slidesToScroll: 1,
...
// aside burger
const menuAsideBurger = document.querySelector(".menu-page__burger");
const menuAsideBody = document.querySelector('.menu-page__body');
menuAsideBurger.addEventListener("click", function(){
    menuAsideBurger.classList.toggle('active');
    slideToggle(menuAsideBody);
});
...
for (let i = 0; i < checkboxCategories.length; i++){
    let checkboxElement = checkboxCategories[i];

    checkboxElement.addEventListener('change', function(){
        console.log(checkboxElement);
        checkboxElement.classList.toggle('active');

        let checkboxActiveElement = document.querySelectorAll('.categories-search .checkbox.active');
        if(checkboxActiveElement.length > 0){
            searchSelect.classList.add('categories')
            let checkboxQuantity = document.querySelector('.search-page__quantity');
            checkboxQuantity.innerHTML = checkboxQuantity.getAttribute('data-text') + ' ' + checkboxActiveElement.length
        } else{
...
var input0 = document.getElementById('price-filter__from');
var input1 = document.getElementById('price-filter__to');
...
inputs.forEach(function (input, handle) {
    ...
    input.addEventListener('keydown', function (e) {
        ...
        var steps = pricesSlider.noUiSlider.steps();
...
let filterTitles = document.querySelectorAll(".section-filter__title.spollers");
